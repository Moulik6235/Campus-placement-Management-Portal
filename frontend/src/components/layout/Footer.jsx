    ...
    <footer className="bg-surface-container-high w-full border-t-0 mt-auto">
      <div className="w-full py-12 px-6 flex flex-col md:flex-row justify-between items-center max-w-screen-2xl mx-auto">
        <div className="flex flex-col items-center md:items-start mb-8 md:mb-0 text-center md:text-left">
          ...
          <p className="text-outline-variant text-xs leading-relaxed max-w-md">© 2026 Government College of Commerce and Business Administration. All Rights Reserved.</p>
        </div>
